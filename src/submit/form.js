...
function decode(rawContent) {
  ...
  if (content.startsWith('"') && content.endsWith('"')) {
    // in the new 'docstring' context. Server side code comes as a string with escaped characters.
  ...
  if (formDef) {
    ...
    if (isDocumentBasedForm(formDef)) {
      ...
      if (
        ...
        console.log("inside initAdaptiveForm");
        form = await afModule.initAdaptiveForm(formDef, createForm);
      } else {
        console.log("inside createFormForAuthoring");
